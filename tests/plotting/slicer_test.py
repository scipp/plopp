...
# CASES1D = to_params([Case(('2d', 'mpl-interactive')), Case(('2d', 'plotly'))])
# CASES2D = [c for c in CASES1D if c.values[0].backend[1] != 'plotly']


# @pytest.mark.parametrize('case', CASES2D)
# def test_creation_keep_two_dims(case):
#     case.set_backend()
#     da = data_array(ndim=3)
#     sl = Slicer(da, keep=['xx', 'yy'])
#     assert sl.slider.value == {'zz': 0}
...
# def test_creation_keep_one_dim(case):
#     case.set_backend()
#     da = data_array(ndim=3)
#     sl = Slicer(da, keep=['xx'])
#     assert sl.slider.value == {'zz': 0, 'yy': 0}
...
# @pytest.mark.parametrize('case', CASES2D)
# def test_update_keep_two_dims(case):
#     case.set_backend()
#     da = data_array(ndim=3)
#     sl = Slicer(da, keep=['xx', 'yy'])
#     assert sl.slider.value == {'zz': 0}
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_update_keep_one_dim(case):
#     case.set_backend()
#     da = data_array(ndim=3)
#     sl = Slicer(da, keep=['xx'])
#     assert sl.slider.value == {'zz': 0, 'yy': 0}
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_with_dict_of_data_arrays(case):
#     case.set_backend()
#     a = data_array(ndim=2)
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_with_data_arrays_same_shape_different_coord(case):
#     case.set_backend()
#     a = data_array(ndim=2)
#     b = data_array(ndim=2) * 2.5
#     b.coords['xx'] *= 1.5
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_with_data_arrays_different_shape_along_keep_dim(case):
#     case.set_backend()
#     a = data_array(ndim=2)
#     b = data_array(ndim=2) * 2.5
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_with_data_arrays_different_shape_along_non_keep_dim_raises(case):
#     case.set_backend()
#     a = data_array(ndim=2)
#     b = data_array(ndim=2) * 2.5
#     with pytest.raises(
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_raises_ValueError_when_given_binned_data(case):
#     case.set_backend()
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_mixing_raw_data_and_nodes(case):
#     case.set_backend()
#     a = data_array(ndim=2)
#     b = 6.7 * a
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_raises_when_requested_keep_dims_do_not_exist(case):
#     case.set_backend()
#     da = data_array(ndim=3)
#     with pytest.raises(
...
# @pytest.mark.parametrize('case', CASES1D)
# def test_raises_when_number_of_keep_dims_requested_is_bad(case):
#     case.set_backend()
...
# @pytest.mark.parametrize('case', CASES2D)
# def test_update_triggers_autoscale(case):
#     case.set_backend()
#     da = sc.DataArray(
