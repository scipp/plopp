...
def figure(*args, **kwargs):
    if 'ipympl' in get_backend():
        from .figure_interactive import FigureInteractive
        return FigureInteractive(*args, **kwargs)
    else:
        from .figure_static import FigureStatic
        return FigureStatic(*args, **kwargs)
...
#         # self._uses_widget_backend = hasattr(self._fig.canvas, "on_widget_constructed")
