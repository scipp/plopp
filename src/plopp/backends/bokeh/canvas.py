...
class Canvas:
    ...
    def __init__(
        ...
        **ignored,
        ...
        self.fig = bokeh_figure(title=title, x_axis_label="x", y_axis_label="y")
    ...
    def xlabel(self) -> str:
        ...
        """
        return self.fig.xaxis.axis_label

    @xlabel.setter
    def xlabel(self, lab: str):
        self.fig.xaxis.axis_label = lab
    ...
    def ylabel(self) -> str:
        ...
        """
        return self.fig.yaxis.axis_label

    @ylabel.setter
    def ylabel(self, lab: str):
        self.fig.yaxis.axis_label = lab
    ...
    def xscale(self) -> Literal['linear', 'log']:
        ...
        """
        return 'log' if isinstance(self.fig.x_scale, LogScale) else 'linear'
    ...
    def yscale(self) -> Literal['linear', 'log']:
        ...
        """
        return 'log' if isinstance(self.fig.y_scale, LogScale) else 'linear'
    ...
    def xmin(self) -> float:
        ...
        """
        # Get the current x-axis range in bokeh
        return self.fig.x_range.start

    @xmin.setter
    def xmin(self, value: float):
        self.fig.x_range.start = value
    ...
    def xmax(self) -> float:
        ...
        """
        return self.fig.x_range.end

    @xmax.setter
    def xmax(self, value: float):
        self.fig.x_range.end = value
    ...
    def xrange(self, value: tuple[float, float]):
        self.fig.x_range = Range1d(start=value[0], end=value[1])
    ...
    def ymin(self) -> float:
        ...
        """
        return self.fig.y_range.start

    @ymin.setter
    def ymin(self, value: float):
        self.fig.y_range.start = value
    ...
    def ymax(self) -> float:
        ...
        """
        return self.fig.y_range.end

    @ymax.setter
    def ymax(self, value: float):
        self.fig.y_range.end = value
    ...
    def yrange(self, value: tuple[float, float]):
        self.fig.y_range = Range1d(start=value[0], end=value[1])
